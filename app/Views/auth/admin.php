...
<head>
  ...
  <title>Administrator Login - FIFTY 50 MEDTECHIE</title>
  ...
  <style>
    ...
    * {
    ...
    .login-card::before {
      ...
      right: 0;
      height: 4px;
      background: linear-gradient(90deg, var(--admin-color), var(--admin-color-600));
    }
    ...
    .role-badge {
      ...
      gap: 8px;
      padding: 8px 16px;
      background: linear-gradient(135deg, var(--admin-color) 0%, var(--admin-color-600) 100%);
      color: white;
      border-radius: 20px;
      font-size: 14px;
      font-weight: 600;
  ...
  <div class="login-container">
    <div class="login-card">
      <div class="card-header">
        ...
        <p class="welcome-text">Please sign in with your administrator credentials</p>
      </div>
      ...
      <div class="card-body">
        ...
        <form method="post" action="<?= site_url('login/admin') ?>" id="loginForm">
