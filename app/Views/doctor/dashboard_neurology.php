...
<html lang="en"><head>
  ...
  <title>Neurology Dashboard</title>
...
<header class="dash-topbar" role="banner"><div class="topbar-inner">
    ...
    <div class="brand-text">
      <h1 style="font-size:1.25rem;margin:0"><?= esc($doctorSpecialization ?? 'Neurologist') ?></h1>
      <small><?= esc($doctorDepartment['name'] ?? 'Neurology') ?> Department</small>
    </div>
  </div>
  <div class="top-right" aria-label="User session">
    <div style="display:flex;align-items:center;gap:12px">
      <span style="padding:6px 12px;background:#f3e8ff;color:#7c3aed;border-radius:6px;font-size:0.875rem;font-weight:600">
        <i class="fa-solid fa-brain" style="margin-right:4px"></i>
        Neurologist
      </span>
...
<?= $this->include('doctor/sidebar', [
  ...
  <main class="content">
    ...
    <section class="kpi-grid" aria-label="Key indicators">
      ...
      <article class="kpi-card" style="background:#f3e8ff;border-left:4px solid #7c3aed"><div class="kpi-head"><span>Neurological Cases</span><i class="fa-solid fa-brain" aria-hidden="true"></i></div><div class="kpi-value" style="color:#6d28d9" aria-live="polite"><?= esc(count($assignedPatients ?? [])) ?></div></article>
    </section>
    ...
    <section class="panel" style="margin-top:16px">
      ...
      <div class="panel-body" style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="<?= site_url('doctor/neurology/imaging') ?>" style="padding:10px 14px;border:1px solid #e5e7eb;border-radius:8px;text-decoration:none;background:#f3e8ff;color:#7c3aed"><i class="fa-solid fa-brain" style="margin-right:4px"></i>Neurological Imaging</a>
      </div>
    </section>
    ...
    <section class="panel" style="margin-top:16px">
      <div class="panel-head"><h2 style="margin:0;font-size:1.1rem">Neurological Imaging</h2></div>
      <div class="panel-body" style="padding:20px;text-align:center;color:#6b7280">
        ...
        <p style="margin:0">Neurological imaging requests will be displayed here.</p>
        <p style="margin:8px 0 0 0;font-size:0.875rem">Review CT scans, MRI, and EEG results for neurological patients.</p>
      </div>
    </section>
