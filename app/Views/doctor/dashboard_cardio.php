...
<html lang="en"><head>
  ...
  <title>Cardiologist Dashboard</title>
...
<header class="dash-topbar" role="banner"><div class="topbar-inner">
    ...
    <div class="brand-text">
      <h1 style="font-size:1.25rem;margin:0"><?= esc($doctorSpecialization ?? 'Cardiologist') ?></h1>
      <small><?= esc($doctorDepartment['name'] ?? 'Cardiology') ?> Department</small>
    </div>
  </div>
  <div class="top-right" aria-label="User session">
    <div style="display:flex;align-items:center;gap:12px">
      <span style="padding:6px 12px;background:#fee2e2;color:#991b1b;border-radius:6px;font-size:0.875rem;font-weight:600">
        <i class="fa-solid fa-heart-pulse" style="margin-right:4px"></i>
        Cardiologist
      </span>
...
<?= $this->include('doctor/sidebar', [
  ...
  <main class="content">
    ...
    <section class="kpi-grid" aria-label="Key indicators">
      ...
      <article class="kpi-card" style="background:#fee2e2;border-left:4px solid #ef4444"><div class="kpi-head"><span>Pending ECG</span><i class="fa-solid fa-heart-pulse" aria-hidden="true"></i></div><div class="kpi-value" style="color:#dc2626" aria-live="polite"><?= esc($pendingECG ?? 0) ?></div></article>
    </section>
    ...
    <section class="panel" style="margin-top:16px">
      ...
      <div class="panel-body" style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="<?= site_url('doctor/lab-requests/new?test_type=ecg') ?>" style="padding:10px 14px;border:1px solid #e5e7eb;border-radius:8px;text-decoration:none;background:#fee2e2;color:#991b1b"><i class="fa-solid fa-heart-pulse" style="margin-right:4px"></i>Request ECG</a>
      </div>
    </section>
    ...
    <section class="panel" style="margin-top:16px">
      <div class="panel-head"><h2 style="margin:0;font-size:1.1rem">ECG Results</h2></div>
      <div class="panel-body" style="padding:20px;text-align:center;color:#6b7280">
        <i class="fa-solid fa-heart-pulse" style="font-size:3rem;opacity:0.3;margin-bottom:12px;display:block"></i>
        <p style="margin:0">ECG results will be displayed here.</p>
        <p style="margin:8px 0 0 0;font-size:0.875rem">Review and analyze ECG readings for cardiac patients.</p>
      </div>
    </section>
