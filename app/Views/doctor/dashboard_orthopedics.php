...
<html lang="en"><head>
  ...
  <title>Orthopedics Dashboard</title>
...
<header class="dash-topbar" role="banner"><div class="topbar-inner">
    ...
    <div class="brand-text">
      <h1 style="font-size:1.25rem;margin:0"><?= esc($doctorSpecialization ?? 'Orthopedic Surgeon') ?></h1>
      <small><?= esc($doctorDepartment['name'] ?? 'Orthopedics') ?> Department</small>
    </div>
  </div>
  <div class="top-right" aria-label="User session">
    <div style="display:flex;align-items:center;gap:12px">
      <span style="padding:6px 12px;background:#e0f2fe;color:#0369a1;border-radius:6px;font-size:0.875rem;font-weight:600">
        <i class="fa-solid fa-bone" style="margin-right:4px"></i>
        Orthopedics
      </span>
...
<?= $this->include('doctor/sidebar', [
  'specialization' => $doctorSpecialization ?? 'Orthopedic Surgeon',
  ...
  <main class="content">
    ...
    <section class="kpi-grid" aria-label="Key indicators">
      ...
      <article class="kpi-card" style="background:#e0f2fe;border-left:4px solid #3b82f6"><div class="kpi-head"><span>Scheduled Surgeries</span><i class="fa-solid fa-kit-medical" aria-hidden="true"></i></div><div class="kpi-value" style="color:#1e40af" aria-live="polite">0</div></article>
    </section>
    ...
    <section class="panel" style="margin-top:16px">
      ...
      <div class="panel-body" style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="<?= site_url('doctor/surgeries/schedule') ?>" style="padding:10px 14px;border:1px solid #e5e7eb;border-radius:8px;text-decoration:none;background:#e0f2fe;color:#1e40af"><i class="fa-solid fa-kit-medical" style="margin-right:4px"></i>Schedule Surgery</a>
      </div>
    </section>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:16px">
      <section class="panel">
        ...
        <div class="panel-body" style="padding:20px;text-align:center;color:#6b7280">
          ...
          <p style="margin:0">Orthopedic surgery schedule will be displayed here.</p>
          <p style="margin:8px 0 0 0;font-size:0.875rem">View and manage upcoming orthopedic procedures.</p>
        </div>
      </section>
    ...
    <section class="panel" style="margin-top:16px">
      ...
      <div class="panel-body" style="padding:20px;text-align:center;color:#6b7280">
        ...
        <p style="margin:8px 0 0 0;font-size:0.875rem">Patients scheduled for orthopedic surgery requiring pre-op assessment.</p>
      </div>
    </section>
