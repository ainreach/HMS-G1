...
<head>
  ...
  <title>Payment Details - Hospital Management System</title>
...
<header class="dash-topbar" role="banner">
  <div class="topbar-inner">
    <a href="<?= site_url('admin/payments') ?>" class="menu-btn" aria-label="Back to Payments"><i class="fa-solid fa-arrow-left"></i></a>
    <div class="brand">
...
<div class="layout">
  <aside class="simple-sidebar" role="navigation" aria-label="Admin navigation">
    <nav class="side-nav">
      <a href="<?= site_url('dashboard/admin') ?>"><i class="fa-solid fa-chart-pie" style="margin-right:8px"></i>Dashboard</a>
      <a href="<?= site_url('admin/payments') ?>"><i class="fa-solid fa-money-bill-wave" style="margin-right:8px"></i>Payments</a>
      <a href="<?= site_url('admin/invoices') ?>"><i class="fa-solid fa-file-invoice" style="margin-right:8px"></i>Invoices</a>
      <a href="<?= site_url('admin/patients') ?>"><i class="fa-solid fa-users" style="margin-right:8px"></i>Patients</a>
      <a href="<?= site_url('admin/appointments') ?>"><i class="fa-solid fa-calendar" style="margin-right:8px"></i>Appointments</a>
    </nav>
  </aside>
    ...
    <section class="panel">
      <div class="panel-head">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          ...
          <a href="<?= site_url('admin/payments') ?>" class="btn" style="background:#0ea5e9;color:white;text-decoration:none;padding:8px 12px;border-radius:6px;font-size:0.875rem">
      ...
      <div class="panel-body">
        <div style="max-width:600px;margin:0 auto">
          ...
          <div style="background:#fef3c7;padding:20px;border-radius:8px;border-left:4px solid #f59e0b;margin-bottom:20px">
            <h4 style="margin:0 0 15px 0;color:#92400e">Admin Actions</h4>
            <div style="display:flex;gap:10px;flex-wrap:wrap">
              <a href="<?= site_url('admin/payments') ?>" class="btn" style="background:#3b82f6;color:white;text-decoration:none;padding:8px 12px;border-radius:6px;font-size:0.875rem">
                <i class="fa-solid fa-list"></i> All Payments
              </a>
              <a href="<?= site_url('admin/invoices') ?>" class="btn" style="background:#8b5cf6;color:white;text-decoration:none;padding:8px 12px;border-radius:6px;font-size:0.875rem">
