...
<div class="layout">
  <aside class="simple-sidebar" role="navigation" aria-label="Accountant navigation">
    <nav class="side-nav">
      ...
      <a href="<?= site_url('accountant/consolidated-bills') ?>" class="active" aria-current="page"><i class="fa-solid fa-file-invoice" style="margin-right:8px"></i>Consolidated Bills</a>
