  ...
  <aside class="simple-sidebar" role="navigation" aria-label="Reception navigation">
    <nav class="side-nav">
      ...
      <div class="nav-section">
        ...
        <a href="<?= site_url('reception/rooms') ?>" class="<?= (strpos(current_url(), 'reception/rooms') !== false || strpos(current_url(), 'reception/in-patients') !== false) ? 'active' : '' ?>" aria-current="page">
